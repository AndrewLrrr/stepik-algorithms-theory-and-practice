...
class TestPriorityQueue(unittest.TestCase):
    def test_sift_up(self):
        ...
        pq._sift_up(12, 6)
        self.assertEqual([12, 5, 11, 3, 4, 8, 9], pq)

    def test_sift_down(self):
        pq = PriorityQueue()
        pq.extend([3, 11, 9, 5, 4, 8])
        pq._sift_down(3, 0)
        self.assertEqual([11, 5, 9, 3, 4, 8], pq)
    ...
    def test_append(self):
        ...
        self.assertEqual([12, 5, 11, 3, 4, 8, 9], pq)
        pq.append(15)
        self.assertEqual([15, 12, 11, 5, 4, 8, 9, 3], pq)
        pq.append(10)
        self.assertEqual([15, 12, 11, 10, 4, 8, 9, 3, 5], pq)
    ...
    def test_extract_max(self):
        ...
        self.assertEqual([12, 10, 11, 5, 4, 8, 9, 3], pq)
        _max = pq.extract_max()
        self.assertEqual(12, _max)
        self.assertEqual([11, 10, 9, 5, 4, 8, 3], pq)
